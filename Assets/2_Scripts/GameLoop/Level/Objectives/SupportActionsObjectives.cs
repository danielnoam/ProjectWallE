...
namespace ProjectWallE.GameLoop
{
    ...
    public class CallSupportAction : BaseLevelObjective
    {
        ...
        public override string Description => supportAction ? $"Call {supportAction.Label}" : "Call a support action";

        protected override string DefaultTutorialText => "Press *[E]* to open support menu";
