...
{
    private static readonly int RotationX = Shader.PropertyToID("_RotationX");
    private static readonly int RotationZ = Shader.PropertyToID("_RotationZ");
    ...
    private void Update()
    {
        ...
        rend.sharedMaterial.SetFloat(RotationX, _wobbleAmountX);
        rend.sharedMaterial.SetFloat(RotationZ, _wobbleAmountZ);
    ...
    private void UpdatePos(float deltaTime)
    {
        ...
        rend.sharedMaterial.SetVector(FillAmount, _pos);
    }
