...
{
    /// <summary>
    /// Custom property drawer for AudioMapping that displays ID and audio object fields side by side,
    /// and validates that only AudioClips or SOAudioProfiles can be assigned.
    /// </summary>
