...
{
    /// <summary>
    /// ScriptableObject for defining and applying TextMeshPro rich text formatting styles.
    /// </summary>
    ...
    public class SOFontStyle : ScriptableObject
    {
        ...
        /// <summary>
        /// Applies the style to text content wrapped between matching symbol characters.
        /// </summary>
