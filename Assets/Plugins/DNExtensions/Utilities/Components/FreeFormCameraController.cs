...
namespace DNExtensions.Utilities
{
    ...
    /// <summary>
    /// Free camera controller with movement, rotation and zoom. Runs on unscaled time.
    /// </summary>
    ...
    public class FreeFormCameraController : MonoBehaviour
    {
        ...
        [SerializeField, Min(1f)] private float rotationSpeed = 25f;
        ...
        private void HandleMovement()
        {
            ...
            transform.position += move * (moveSpeed * speedMultiplier * Time.unscaledDeltaTime);
        }
        ...
        private void HandleRotation()
        {
            ...
            _yaw   += mouseDelta.x * rotationSpeed * Time.unscaledDeltaTime * (invertX ? -1 : 1);
            _pitch -= mouseDelta.y * rotationSpeed * Time.unscaledDeltaTime * (invertY ? -1 : 1);
        ...
        private void HandleZoom()
        {
            ...
            if (scroll != 0f)
            {
                float newFOV = cam.fieldOfView - scroll * zoomSpeed * 100f * Time.unscaledDeltaTime;
                cam.fieldOfView = Mathf.Clamp(newFOV, zoomLimits.minValue, zoomLimits.maxValue);
            }
        }

        /// <summary>
        /// Enables or disables individual controller features at runtime.
        /// </summary>
