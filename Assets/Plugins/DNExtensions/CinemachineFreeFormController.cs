...
public class CinemachineFreeFormController : MonoBehaviour
{
    ...
    private void HandleRotation()
    {
        ...
        _currentRotation.y = Mathf.Clamp(_currentRotation.y, -89f, 89f);
    ...
    private void HandleZoom()
    {
        ...
        if (scroll != 0f)
        {
            float newFOV = virtualCamera.Lens.FieldOfView - scroll * zoomSpeed * 100f * Time.deltaTime;
            virtualCamera.Lens.FieldOfView = Mathf.Clamp(newFOV, zoomLimits.minValue, zoomLimits.maxValue);
        }
    }
}